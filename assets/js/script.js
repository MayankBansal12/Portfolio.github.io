...
const type=new Typed(".career-title",{
  strings: ["&lt; Web Developer /&gt;","&lt; Web Designer &gt;","{ Freelancer }","Let's Collaborate!"],
  typeSpeed: 100,
  startDelay: 2000,
  loop: true
})
...
contactForm.addEventListener("submit", (event) => {
  ...
  emailjs.send("service_x75md1t", "template_pwgmoel", {
...
const setActiveNavLink = () => {
  ...
  sections.forEach((section) => {
    if (isInViewport(section)) {
      ...
      const targetNavLink = document.querySelector(`.nav-link[href="#${section.id}"]`);
